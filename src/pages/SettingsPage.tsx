...
export default function SettingsPage() {
  ...
  const setDsField = (table: 'dsTradein' | 'dsConsult' | 'dsBackup', k: keyof DsFieldMap, v: string) =>
  ...
  const DS_TABLES: Array<['dsTradein' | 'dsConsult' | 'dsBackup', string]> = [
    ['dsTradein', 'DS Thu cũ'],
    ['dsConsult', 'DS Tư vấn'],
    ['dsBackup', 'DS Backup'],
  ];
        ...
        <Section title="2 · Kết nối Lark" disabled={draft.useMock}>
          ...
          {draft.mode === 'proxy' ? (
            <Input
              ...
              hint="Client gọi {URL}/dsTradein, /dsConsult, /dsBackup, /checkin, /orders"
            />
          ) : (
