 ...
 *
 * `fetchLarkData` returns the raw records for all five logical tables (3 DS
 * registries + Check in + Orders). In mock mode it returns the bundled workbook
...
const CORE_KEYS: TableKey[] = ['dsTradein', 'dsConsult', 'dsBackup', 'checkin', 'orders'];
